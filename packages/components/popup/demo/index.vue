<template>
  <div>
    <demoBlock title="通过v-model绑定开启或关闭的属性">
      <uv-button
        type="primary"
        @click="show=true"
      >
    ...
    <demoBlock title="允许点击遮罩后关闭popup">
      <uv-button
        type="primary"
        @click="show22=true"
      >
...
import { uvPopup, uvButton } from 'uv-ui'
import { ref } from 'vue'
